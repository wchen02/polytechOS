...
//			// NO WAY! you double, not squaring it, imagine if you have 1000 elements and u square it .....
//			_container =new T[ _capacity ];
...
//			return _container[i];
//	}
//	// Not all path returns a value, if I were you I would just let it crash... and this bound checking doesn't check negatives
//	// This is a getter
//
